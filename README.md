...
# Introduction 
    Dive into the data job market ! Focusing on data analyst roles, this project explores top_payings jobs , in demand skills , and where high demand meets high salary in data analystics .
